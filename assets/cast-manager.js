      ...
      <span class="premium-cast-badge premium-cast-badge-new" aria-label="NEW 新人">
        <svg class="premium-cast-badge-svg premium-cast-badge-svg-new" viewBox="0 0 64 78" role="img" aria-hidden="true" focusable="false">
          <defs>
            ...
            <linearGradient id="adminNewBadgeShine" x1="0" y1="0" x2="1" y2="1">
          ...
          <path d="M12 5H52Q57 5 57 10V61L43 61L32 74L21 61H7V10Q7 5 12 5Z" fill="url(#adminNewBadgeFill)" stroke="#ffe9a9" stroke-width="3" filter="url(#adminNewBadgeShadow)"/>
          <path d="M13 9H51Q53 9 53 11V17Q34 8 11 28V11Q11 9 13 9Z" fill="url(#adminNewBadgeShine)"/>
    ...
    return `
      <span class="premium-cast-badge premium-cast-badge-recommended" aria-label="おすすめ">
        <svg class="premium-cast-badge-svg premium-cast-badge-svg-recommended" viewBox="0 0 74 58" role="img" aria-hidden="true" focusable="false">
          ...
          <path d="M37 4C41 10 48 7 52 13C59 13 62 19 59 25C66 29 64 37 57 39C57 47 50 51 43 48C39 55 31 55 27 48C20 51 13 47 13 39C6 37 8 29 15 25C12 19 15 13 22 13C26 7 33 10 37 4Z" fill="url(#adminRecommendedBadgeFill)" stroke="#8d5c08" stroke-width="3" filter="url(#adminRecommendedBadgeShadow)"/>
          <path d="M22 15C31 8 45 9 53 17C44 14 28 17 16 29C15 24 17 19 22 15Z" fill="url(#adminRecommendedBadgeGlow)"/>
          <path d="M20 18C28 12 46 12 54 22" fill="none" stroke="#fff7c8" stroke-width="2" stroke-linecap="round" opacity=".55"/>
          <text x="37" y="35" text-anchor="middle" fill="#fff" font-size="13" font-weight="900" font-family="'Hiragino Sans', 'Yu Gothic', sans-serif" paint-order="stroke" stroke="#8b5705" stroke-width="2" stroke-linejoin="round">おすすめ</text>
        </svg>
      </span>
    `;
  }
