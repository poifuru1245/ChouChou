...
(async () => {
    ...
    return `
      <span class="premium-cast-badge premium-cast-badge-new" aria-label="NEW 新人">
        <svg class="premium-cast-badge-svg premium-cast-badge-svg-new" viewBox="0 0 70 82" role="img" aria-hidden="true" focusable="false">
          <defs>
            <linearGradient id="adminNewBadgeFill" x1="0" y1="0" x2="0" y2="1">
            ...
            <linearGradient id="adminNewBadgeGloss" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stop-color="#fff" stop-opacity=".88"/>
              <stop offset="42%" stop-color="#fff" stop-opacity=".2"/>
              <stop offset="100%" stop-color="#fff" stop-opacity="0"/>
            </linearGradient>
            <filter id="adminNewBadgeShadow" x="-25%" y="-20%" width="150%" height="150%">
              <feDropShadow dx="0" dy="4" stdDeviation="2.2" flood-color="#5a2441" flood-opacity=".2"/>
            </filter>
          </defs>
          <path d="M17 3H53Q60 3 60 11V62H48L35 78L22 62H10V11Q10 3 17 3Z" fill="#fffefd" filter="url(#adminNewBadgeShadow)"/>
          <path d="M18 7H52Q57 7 57 13V59H46L35 73L24 59H13V13Q13 7 18 7Z" fill="url(#adminNewBadgeFill)" stroke="#d7bb74" stroke-width="1.35"/>
          <path d="M18 9H52Q56 9 56 14V23Q39 16 14 29V14Q14 9 18 9Z" fill="url(#adminNewBadgeGloss)"/>
  ...
  function createRecommendedBadgeSvg() {
    return `
      <span class="premium-cast-badge premium-cast-badge-recommended" aria-label="おすすめ">
        <svg class="premium-cast-badge-svg premium-cast-badge-svg-recommended" viewBox="0 0 80 52" role="img" aria-hidden="true" focusable="false">
          <defs>
            <linearGradient id="adminRecommendedBadgeFill" x1="0" y1="0" x2="0" y2="1">
            ...
            <radialGradient id="adminRecommendedBadgeGlow" cx=".32" cy=".18" r=".72">
              <stop offset="0%" stop-color="#fff" stop-opacity=".72"/>
              <stop offset="42%" stop-color="#fff" stop-opacity=".14"/>
              <stop offset="100%" stop-color="#fff" stop-opacity="0"/>
            </radialGradient>
            <filter id="adminRecommendedBadgeShadow" x="-25%" y="-25%" width="150%" height="150%">
              <feDropShadow dx="0" dy="4" stdDeviation="2.2" flood-color="#5b4215" flood-opacity=".18"/>
            </filter>
          </defs>
          <path d="M9 16Q21 8 40 8Q59 8 71 16Q76 21 77 26Q76 31 71 36Q59 44 40 44Q21 44 9 36Q4 31 3 26Q4 21 9 16Z" fill="#fffef8" filter="url(#adminRecommendedBadgeShadow)"/>
          <path d="M12 17Q23 11 40 11Q57 11 68 17Q72 21 73 26Q72 31 68 35Q57 41 40 41Q23 41 12 35Q8 31 7 26Q8 21 12 17Z" fill="url(#adminRecommendedBadgeFill)" stroke="#a77d2e" stroke-width="1.35"/>
          <path d="M16 17Q29 11 50 13Q62 14 68 21Q45 15 12 28Q11 21 16 17Z" fill="url(#adminRecommendedBadgeGlow)"/>
          ...
          <text x="40" y="32" text-anchor="middle" fill="#fff" font-size="14" font-weight="900" font-family="'Hiragino Sans', 'Yu Gothic', sans-serif" paint-order="stroke" stroke="#96733a" stroke-width=".65" stroke-linejoin="round">おすすめ</text>
        </svg>
      </span>
    `;
  }
