    ...
    return `
      <span class="premium-cast-badge premium-cast-badge-new" aria-label="NEW 新人">
        <svg class="premium-cast-badge-svg premium-cast-badge-svg-new" viewBox="0 0 70 82" role="img" aria-hidden="true" focusable="false">
          ...
          <path d="M14 2H56Q65 2 65 11V63L51 63L35 80L19 63H5V11Q5 2 14 2Z" fill="#fffdf8" filter="url(#adminNewBadgeShadow)"/>
          <path d="M16 5H54Q62 5 62 13V60L49 60L35 76L21 60H8V13Q8 5 16 5Z" fill="url(#adminNewBadgeFill)" stroke="#d8ad46" stroke-width="2.2"/>
          <path d="M18 8H52Q58 8 58 14V25Q42 16 12 31V14Q12 8 18 8Z" fill="url(#adminNewBadgeGloss)"/>
    ...
    return `
      <span class="premium-cast-badge premium-cast-badge-recommended" aria-label="おすすめ">
        <svg class="premium-cast-badge-svg premium-cast-badge-svg-recommended" viewBox="0 0 80 52" role="img" aria-hidden="true" focusable="false">
          ...
          <path d="M9 14Q20 4 40 5Q60 4 71 14L77 26L71 38Q60 48 40 47Q20 48 9 38L3 26Z" fill="#fffdf5" filter="url(#adminRecommendedBadgeShadow)"/>
          <path d="M12 15Q22 8 40 8Q58 8 68 15L73 26L68 37Q58 44 40 44Q22 44 12 37L7 26Z" fill="url(#adminRecommendedBadgeFill)" stroke="#8d5c08" stroke-width="2.2"/>
          <path d="M15 16Q28 9 51 11Q63 13 68 21Q43 13 12 29Q10 21 15 16Z" fill="url(#adminRecommendedBadgeGlow)"/>
          ...
          <text x="40" y="32" text-anchor="middle" fill="#fff" font-size="14" font-weight="900" font-family="'Hiragino Sans', 'Yu Gothic', sans-serif" paint-order="stroke" stroke="#765005" stroke-width="2.2" stroke-linejoin="round">おすすめ</text>
        </svg>
      </span>
    `;
  }
